          ...
          children: [
            RichText(
              ...
              text: TextSpan(
                ...
                children: [
                  TextSpan(text: "Last updated: ", style: TextStyle(color: textColor)),
                  TextSpan(
                    text: "April 28, 2025\n\n",
                  ...
                  TextSpan(
                    text:
                        "Welcome to our application. We are committed to protecting your personal information and your right to privacy. "
                  ...
                  TextSpan(
                    text:
                        "- Personal Information you disclose to us (such as your name, email address, and other contact details).\n"
                  ...
                  TextSpan(
                    text:
                        "- We may update this privacy policy from time to time. We will notify you of any changes by posting the new Privacy Policy in this app.\n"
                  ...
                  TextSpan(
                    text:
                        "If you have any questions about this Privacy Policy, you can contact us by email: support@example.com\n\n"
